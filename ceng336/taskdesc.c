 ...
 * -----------------------------  task 0 ------------------------------
 **********************************************************************/
rom_desc_tsk rom_desc_transmit = {
	TRANSMIT_PRIO,                       /* prioinit from 0 to 15       */
	stack0,                           /* stack address (16 bits)     */
	TRANSMIT,                            /* start address (16 bits)     */
	READY,                            /* state at init phase         */
	TRANSMIT_ID,                         /* id_tsk from 0 to 15         */
 ...
 * -----------------------------  task 1 ------------------------------
 **********************************************************************/
rom_desc_tsk rom_desc_movebot = {
	MOVEBOT_PRIO,                       /* prioinit from 0 to 15       */
	stack1,                           /* stack address (16 bits)     */
	MOVEBOT,                            /* start address (16 bits)     */
	READY,                            /* state at init phase         */
	MOVEBOT_ID,                         /* id_tsk from 0 to 15         */
