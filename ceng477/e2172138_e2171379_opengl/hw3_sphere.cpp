...
glm::vec3 cameraGaze = glm::vec3(0.0, -1.0, 0.0);
...
void initShaders() {
  ...
  idVertexShader   = initVertexShader("shader_sphere.vert");
  idFragmentShader = initFragmentShader("shader_sphere.frag");
